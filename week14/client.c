...
//     printf("\n--- Boxes Status ---\n");
//     for (int i = 0; i < 4; i++) {
//         if (strlen(boxes[i]) == 0 || strcmp(boxes[i], "empty") == 0) {
//             printf("Box %d: [ ] (Empty)\n", i + 1);
//         } else {
//             printf("Box %d: [%s]\n", i + 1, boxes[i]);
//         }
...
//                 if (strcasecmp(action, "red") == 0 || strcasecmp(action, "blue") == 0 || strcasecmp(action, "yellow") == 0) {
...
//                 } else {
//                     printf("[!] Invalid color! Use: red, blue, yellow, or delete.\n");
//                     continue;
//                 }
//             } else {
