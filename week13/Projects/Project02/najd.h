...
typedef void (*najd_event_cb_t)(najd_string_t *str);
typedef void (*najd_result_cb_t)(najd_string_t *str, najd_string_reader_result_t *result);

typedef struct {
    najd_event_cb_t  on_create;
    najd_event_cb_t  pre_read;
    najd_result_cb_t on_result;
    najd_event_cb_t  post_read;
    najd_event_cb_t  on_delete;
} najd_string_handler_t;
