...
typedef void (*najd_pre_token_cb)(najd_string_t *str);
typedef void (*najd_on_token_cb)(najd_string_reader_result_t *result);
...
struct najd_string_t{
    ...
    najd_pre_token_cb pre_token;
    najd_on_token_cb  on_token;
};
...
static inline void najd_string_set_callbacks(najd_string_t *str, 
                                             najd_pre_token_cb pre_token, 
                                             najd_on_token_cb on_token) {
    if (str) {
        str->pre_token = pre_token;
        str->on_token = on_token;
    }
}
